...
const ts_simple_login_response_1 = await request.post('https://192.168.42.201/ts/simple/login', {
data: {
login: 'Delova',
password: '1'
}
})
await expect(ts_simple_login_response_1, 'Успешный запрос').toBeOK()
const ts_simple_login_response_1Json = await ts_simple_login_response_1.json()

const sedo_employee_bylogin_response_1 = await request.post('https://192.168.42.201/sedo/employee/bylogin', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_employee_bylogin_response_1, 'Успешный запрос').toBeOK()
const sedo_employee_bylogin_response_1Json = await sedo_employee_bylogin_response_1.json()

const sedo_task_statistic_response_1 = await request.post('https://192.168.42.201/sedo/task/statistic', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_task_statistic_response_1, 'Успешный запрос').toBeOK()
const sedo_task_statistic_response_1Json = await sedo_task_statistic_response_1.json()

const sedo_module_all_response_1 = await request.post('https://192.168.42.201/sedo/module/all', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_module_all_response_1, 'Успешный запрос').toBeOK()
const sedo_module_all_response_1Json = await sedo_module_all_response_1.json()

const sedo_ui_setting_all_response_1 = await request.post('https://192.168.42.201/sedo/ui/setting/all', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_ui_setting_all_response_1, 'Успешный запрос').toBeOK()
const sedo_ui_setting_all_response_1Json = await sedo_ui_setting_all_response_1.json()

const sedo_deputy_task_users_response_1 = await request.post('https://192.168.42.201/sedo/deputy/task/users', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_deputy_task_users_response_1, 'Успешный запрос').toBeOK()
const sedo_deputy_task_users_response_1Json = await sedo_deputy_task_users_response_1.json()

const sedo_pref_get_response_1 = await request.post('https://192.168.42.201/sedo/pref/get', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_pref_get_response_1, 'Успешный запрос').toBeOK()
const sedo_pref_get_response_1Json = await sedo_pref_get_response_1.json()

const sedo_security_certificates_response_1 = await request.post('https://192.168.42.201/sedo/security/certificates', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_security_certificates_response_1, 'Успешный запрос').toBeOK()
const sedo_security_certificates_response_1Json = await sedo_security_certificates_response_1.json()

const sedo_notification_sedo_count_response_1 = await request.post('https://192.168.42.201/sedo/notification/sedo/count', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_notification_sedo_count_response_1, 'Успешный запрос').toBeOK()
const sedo_notification_sedo_count_response_1Json = await sedo_notification_sedo_count_response_1.json()

const chat_chats_unread_count_by_chat_response_1 = await request.post('https://192.168.42.201/chat/chats/unread_count_by_chat', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(chat_chats_unread_count_by_chat_response_1, 'Успешный запрос').toBeOK()
const chat_chats_unread_count_by_chat_response_1Json = await chat_chats_unread_count_by_chat_response_1.json()

const sedo_type_config_purchases_response_1 = await request.post('https://192.168.42.201/sedo/type/config/purchases', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_type_config_purchases_response_1, 'Успешный запрос').toBeOK()
const sedo_type_config_purchases_response_1Json = await sedo_type_config_purchases_response_1.json()

const sedo_examination_incoming_types_response_1 = await request.post('https://192.168.42.201/sedo/examination/incoming_types', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_examination_incoming_types_response_1, 'Успешный запрос').toBeOK()
const sedo_examination_incoming_types_response_1Json = await sedo_examination_incoming_types_response_1.json()

const sedo_folder_listFolders_response_1 = await request.post('https://192.168.42.201/sedo/folder/listFolders', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_folder_listFolders_response_1, 'Успешный запрос').toBeOK()
const sedo_folder_listFolders_response_1Json = await sedo_folder_listFolders_response_1.json()

const upsd_psd_project_config_response_1 = await request.post('https://192.168.42.201/upsd/psd/project/config', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(upsd_psd_project_config_response_1, 'Успешный запрос').toBeOK()
const upsd_psd_project_config_response_1Json = await upsd_psd_project_config_response_1.json()

const sedo_maintenance_notice_response_1 = await request.post('https://192.168.42.201/sedo/maintenance/notice', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_maintenance_notice_response_1, 'Успешный запрос').toBeOK()
const sedo_maintenance_notice_response_1Json = await sedo_maintenance_notice_response_1.json()

const sedo_pref_filter_get_response_1 = await request.post('https://192.168.42.201/sedo/pref/filter/get', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_pref_filter_get_response_1, 'Успешный запрос').toBeOK()
const sedo_pref_filter_get_response_1Json = await sedo_pref_filter_get_response_1.json()

const sedo_type_config_response_1 = await request.post('https://192.168.42.201/sedo/type/config', {
data: {
type: 'documentType',
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_type_config_response_1, 'Успешный запрос').toBeOK()
const sedo_type_config_response_1Json = await sedo_type_config_response_1.json()

const sedo_type_config_response_2 = await request.post('https://192.168.42.201/sedo/type/config', {
data: {
type: 'documentType',
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_type_config_response_2, 'Успешный запрос').toBeOK()
const sedo_type_config_response_2Json = await sedo_type_config_response_2.json()

const sedo_type_config_response_3 = await request.post('https://192.168.42.201/sedo/type/config', {
data: {
type: 'documentType',
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_type_config_response_3, 'Успешный запрос').toBeOK()
const sedo_type_config_response_3Json = await sedo_type_config_response_3.json()

const upsd_psd_project_mes_response_1 = await request.post('https://192.168.42.201/upsd/psd/project/mes', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(upsd_psd_project_mes_response_1, 'Успешный запрос').toBeOK()
const upsd_psd_project_mes_response_1Json = await upsd_psd_project_mes_response_1.json()

const sedo_task_list_response_1 = await request.post('https://192.168.42.201/sedo/task/list?limit=25&offset=0', {
data: {
dueFrom: null,
dueTo: null,
...
await expect(sedo_task_list_response_1, 'Успешный запрос').toBeOK()
const sedo_task_list_response_1Json = await sedo_task_list_response_1.json()

const sedo_task_filters_response_1 = await request.post('https://192.168.42.201/sedo/task/filters', {
data: {
dueFrom: null,
dueTo: null,
docType: 'ListTaskDocument',
...
await expect(sedo_task_filters_response_1, 'Успешный запрос').toBeOK()
const sedo_task_filters_response_1Json = await sedo_task_filters_response_1.json()

const sedo_task_statistic_response_2 = await request.post('https://192.168.42.201/sedo/task/statistic', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_task_statistic_response_2, 'Успешный запрос').toBeOK()
const sedo_task_statistic_response_2Json = await sedo_task_statistic_response_2.json()

const sedo_content_edit_list_response_1 = await request.post('https://192.168.42.201/sedo/content/edit/list', {
data: {
ids: [
sedo_task_list_response_1Json.content[0].id,
sedo_task_list_response_1Json.content[1].id,
sedo_task_list_response_1Json.content[1].id,
sedo_task_list_response_1Json.content[3].id,
sedo_task_list_response_1Json.content[4].id,
sedo_task_list_response_1Json.content[5].id,
sedo_task_list_response_1Json.content[1].id,
sedo_task_list_response_1Json.content[5].id,
sedo_task_list_response_1Json.content[5].id,
sedo_task_list_response_1Json.content[9].id,
sedo_task_list_response_1Json.content[10].id,
sedo_task_list_response_1Json.content[11].id,
sedo_task_list_response_1Json.content[12].id,
sedo_task_list_response_1Json.content[13].id,
sedo_task_list_response_1Json.content[14].id,
sedo_task_list_response_1Json.content[14].id,
sedo_task_list_response_1Json.content[14].id,
sedo_task_list_response_1Json.content[17].id,
sedo_task_list_response_1Json.content[18].id,
sedo_task_list_response_1Json.content[18].id,
sedo_task_list_response_1Json.content[12].id,
sedo_task_list_response_1Json.content[21].id,
sedo_task_list_response_1Json.content[22].id,
sedo_task_list_response_1Json.content[23].id,
sedo_task_list_response_1Json.content[0].id
],
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_content_edit_list_response_1, 'Успешный запрос').toBeOK()
const sedo_content_edit_list_response_1Json = await sedo_content_edit_list_response_1.json()

const sedo_task_filters_response_2 = await request.post('https://192.168.42.201/sedo/task/filters', {
data: {
dueFrom: null,
dueTo: null,
docType: 'ListTaskDocument',
...
await expect(sedo_task_filters_response_2, 'Успешный запрос').toBeOK()
const sedo_task_filters_response_2Json = await sedo_task_filters_response_2.json()

const sedo_favorite_list_response_1 = await request.post('https://192.168.42.201/sedo/favorite/list', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_favorite_list_response_1, 'Успешный запрос').toBeOK()
const sedo_favorite_list_response_1Json = await sedo_favorite_list_response_1.json()

const sedo_classification_response_1 = await request.post('https://192.168.42.201/sedo/classification', {
data: {
query: null,
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_classification_response_1, 'Успешный запрос').toBeOK()
const sedo_classification_response_1Json = await sedo_classification_response_1.json()

const sedo_classification_00xxxxxx000006iq_template_response_1 = await request.post('https://192.168.42.201/sedo/classification/00xxxxxx000006iq/template', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_classification_00xxxxxx000006iq_template_response_1, 'Успешный запрос').toBeOK()
const sedo_classification_00xxxxxx000006iq_template_response_1Json = await sedo_classification_00xxxxxx000006iq_template_response_1.json()

const sedo_document_create_from_classification_response_1 = await request.post('https://192.168.42.201/sedo/document/create/from_classification', {
data: {
classificationId: sedo_favorite_list_response_1Json[2].id,
...
await expect(sedo_document_create_from_classification_response_1, 'Успешный запрос').toBeOK()
const sedo_document_create_from_classification_response_1Json = await sedo_document_create_from_classification_response_1.json()

const sedo_maintenance_notice_response_2 = await request.post('https://192.168.42.201/sedo/maintenance/notice', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_maintenance_notice_response_2, 'Успешный запрос').toBeOK()
const sedo_maintenance_notice_response_2Json = await sedo_maintenance_notice_response_2.json()

const sedo_doc_settings_get_response_1 = await request.post('https://192.168.42.201/sedo/doc_settings/get', {
data: {
documentType: 'ddt_outcoming_type_doc',
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_doc_settings_get_response_1, 'Успешный запрос').toBeOK()
const sedo_doc_settings_get_response_1Json = await sedo_doc_settings_get_response_1.json()

const sedo_employee_00xxxxxx000012bj_response_1 = await request.post('https://192.168.42.201/sedo/employee/00xxxxxx000012bj', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_employee_00xxxxxx000012bj_response_1, 'Успешный запрос').toBeOK()
const sedo_employee_00xxxxxx000012bj_response_1Json = await sedo_employee_00xxxxxx000012bj_response_1.json()

const sedo_task_active_response_1 = await request.post('https://192.168.42.201/sedo/task/active', {
data: {
filter: {
performerId: sedo_employee_bylogin_response_1Json.r_object_id
},
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_task_active_response_1, 'Успешный запрос').toBeOK()
const sedo_task_active_response_1Json = await sedo_task_active_response_1.json()

const sedo_content_edit_list_response_2 = await request.post('https://192.168.42.201/sedo/content/edit/list', {
data: {
ids: [
null,
],
...
await expect(sedo_content_edit_list_response_2, 'Успешный запрос').toBeOK()
const sedo_content_edit_list_response_2Json = await sedo_content_edit_list_response_2.json()

const sedo_type_config_ddt_outcoming_type_doc_design_response_1 = await request.post('https://192.168.42.201/sedo/type/config/ddt_outcoming_type_doc/design', {
data: {
...
await expect(sedo_type_config_ddt_outcoming_type_doc_design_response_1, 'Успешный запрос').toBeOK()
const sedo_type_config_ddt_outcoming_type_doc_design_response_1Json = await sedo_type_config_ddt_outcoming_type_doc_design_response_1.json()

const sedo_entity_list_response_1 = await request.post('https://192.168.42.201/sedo/entity/list?limit=100&offset=0', {
data: {
id: 'dsid_stamp',
type: 'ddt_dict_stamp',
...
await expect(sedo_entity_list_response_1, 'Успешный запрос').toBeOK()
const sedo_entity_list_response_1Json = await sedo_entity_list_response_1.json()

const sedo_reservation_reg_number_attributes_ddt_outcoming_type_doc_response_1 = await request.post('https://192.168.42.201/sedo/reservation_reg_number/attributes/ddt_outcoming_type_doc', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_reservation_reg_number_attributes_ddt_outcoming_type_doc_response_1, 'Успешный запрос').toBeOK()
const sedo_reservation_reg_number_attributes_ddt_outcoming_type_doc_response_1Json = await sedo_reservation_reg_number_attributes_ddt_outcoming_type_doc_response_1.json()

const sedo_employee_query_response_1 = await request.post('https://192.168.42.201/sedo/employee/query', {
data: {
filter: {
signature: 'min_position_level',
stamp: sedo_document_create_from_classification_response_1Json.values.dsid_stamp,
filterIds: null,
...
await expect(sedo_employee_query_response_1, 'Успешный запрос').toBeOK()
const sedo_employee_query_response_1Json = await sedo_employee_query_response_1.json()

const sedo_content_edit_list_response_3 = await request.post('https://192.168.42.201/sedo/content/edit/list', {
data: {
ids: [
null,
],
...
await expect(sedo_content_edit_list_response_3, 'Успешный запрос').toBeOK()
const sedo_content_edit_list_response_3Json = await sedo_content_edit_list_response_3.json()

const sedo_document_create_response_1 = await request.post('https://192.168.42.201/sedo/document/create', {
data: {
useContentTemplate: false,
values: {
...
dsid_executor_empl: sedo_employee_bylogin_response_1Json.r_object_id,
dss_signer_branch: null,
dsid_classification: sedo_favorite_list_response_1Json[2].id,
dsid_stamp: sedo_document_create_from_classification_response_1Json.values.dsid_stamp,
dss_home: 'TEST',
dsid_agent_person: null,
dss_addressee_organization: null,
dss_signer_organization: null,
dsid_author_empl: sedo_employee_bylogin_response_1Json.r_object_id,
dsid_document_kind: sedo_document_create_from_classification_response_1Json.values.dsid_document_kind,
useAutogeneratedContent: true,
dss_status: 'unsaved',
dsid_policy: sedo_document_create_from_classification_response_1Json.values.dsid_policy,
dss_description: '213123123',
dsid_signer_empl: sedo_task_list_response_1Json.content[12].fromWhomEmployee.emplId,
...
dsid_signer_empl_emplId: sedo_task_list_response_1Json.content[12].fromWhomEmployee.emplId,
type_content: true,
...
await expect(sedo_document_create_response_1, 'Успешный запрос').toBeOK()
const sedo_document_create_response_1Json = await sedo_document_create_response_1.json()

const sedo_document_get_response_1 = await request.post('https://192.168.42.201/sedo/document/get', {
data: {
id: sedo_document_create_response_1Json.id,
type: 'ddt_outcoming_type_doc',
classificationId: sedo_favorite_list_response_1Json[2].id,
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_document_get_response_1, 'Успешный запрос').toBeOK()
const sedo_document_get_response_1Json = await sedo_document_get_response_1.json()

const sedo_task_statistic_response_3 = await request.post('https://192.168.42.201/sedo/task/statistic', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_task_statistic_response_3, 'Успешный запрос').toBeOK()
const sedo_task_statistic_response_3Json = await sedo_task_statistic_response_3.json()

const sedo_document_get_audit_response_1 = await request.post('https://192.168.42.201/sedo/document/get/audit', {
data: {
id: sedo_document_create_response_1Json.id,
type: 'ddt_outcoming_type_doc',
classificationId: sedo_favorite_list_response_1Json[2].id,
...
await expect(sedo_document_get_audit_response_1, 'Успешный запрос').toBeOK()
const sedo_doc_settings_get_response_2 = await request.post('https://192.168.42.201/sedo/doc_settings/get', {
data: {
dsidDocument: sedo_document_create_response_1Json.id,
documentType: 'ddt_outcoming_type_doc',
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_doc_settings_get_response_2, 'Успешный запрос').toBeOK()
const sedo_doc_settings_get_response_2Json = await sedo_doc_settings_get_response_2.json()

const sedo_version_list_00000002001e4axf_response_1 = await request.post('https://192.168.42.201/sedo/version/list/00000002001e4axf', {
data: {
limit: 25,
offset: 0,
token: ts_simple_login_response_1Json.token
...
await expect(sedo_version_list_00000002001e4axf_response_1, 'Успешный запрос').toBeOK()
const sedo_version_list_00000002001e4axf_response_1Json = await sedo_version_list_00000002001e4axf_response_1.json()

const sedo_entity_list_response_2 = await request.post('https://192.168.42.201/sedo/entity/list', {
data: {
type: 'ddt_dict_type_content',
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_entity_list_response_2, 'Успешный запрос').toBeOK()
const sedo_entity_list_response_2Json = await sedo_entity_list_response_2.json()

const sedo_content_groups_response_1 = await request.post('https://192.168.42.201/sedo/content/groups', {
data: {
documentId: sedo_document_create_response_1Json.id,
docType: 'ddt_outcoming_type_doc',
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_content_groups_response_1, 'Успешный запрос').toBeOK()
const sedo_content_groups_response_1Json = await sedo_content_groups_response_1.json()

const sedo_content_filters_response_1 = await request.post('https://192.168.42.201/sedo/content/filters', {
data: {
id: sedo_document_create_response_1Json.id,
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_content_filters_response_1, 'Успешный запрос').toBeOK()
const sedo_content_filters_response_1Json = await sedo_content_filters_response_1.json()

const sedo_content_version_list_response_1 = await request.post('https://192.168.42.201/sedo/content/version/list', {
data: {
filter: {
dsb_current: true,
docId: sedo_document_create_response_1Json.id
},
limit: 101,
offset: 0,
token: ts_simple_login_response_1Json.token
...
await expect(sedo_content_version_list_response_1, 'Успешный запрос').toBeOK()
const sedo_content_version_list_response_1Json = await sedo_content_version_list_response_1.json()

const sedo_task_promote_response_1 = await request.post('https://192.168.42.201/sedo/task/promote', {
data: {
id: sedo_document_create_response_1Json.id,
type: 'ddt_outcoming_type_doc',
...
await expect(sedo_task_promote_response_1, 'Успешный запрос').toBeOK()
const sedo_document_get_response_2 = await request.post('https://192.168.42.201/sedo/document/get', {
data: {
id: sedo_document_create_response_1Json.id,
type: 'ddt_outcoming_type_doc',
classificationId: sedo_favorite_list_response_1Json[2].id,
...
await expect(sedo_document_get_response_2, 'Успешный запрос').toBeOK()
const sedo_document_get_response_2Json = await sedo_document_get_response_2.json()

const sedo_task_statistic_response_4 = await request.post('https://192.168.42.201/sedo/task/statistic', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_task_statistic_response_4, 'Успешный запрос').toBeOK()
const sedo_task_statistic_response_4Json = await sedo_task_statistic_response_4.json()

const sedo_document_get_audit_response_2 = await request.post('https://192.168.42.201/sedo/document/get/audit', {
data: {
id: sedo_document_create_response_1Json.id,
type: 'ddt_outcoming_type_doc',
classificationId: sedo_favorite_list_response_1Json[2].id,
...
await expect(sedo_document_get_audit_response_2, 'Успешный запрос').toBeOK()
const sedo_doc_settings_get_response_3 = await request.post('https://192.168.42.201/sedo/doc_settings/get', {
data: {
dsidDocument: sedo_document_create_response_1Json.id,
documentType: 'ddt_outcoming_type_doc',
token: ts_simple_login_response_1Json.token
...
await expect(sedo_doc_settings_get_response_3, 'Успешный запрос').toBeOK()
const sedo_doc_settings_get_response_3Json = await sedo_doc_settings_get_response_3.json()

const sedo_addressee_list_response_1 = await request.post('https://192.168.42.201/sedo/addressee/list', {
data: {
documentId: sedo_document_create_response_1Json.id,
documentType: 'ddt_outcoming_type_doc',
agentsSort: {
...
await expect(sedo_addressee_list_response_1, 'Успешный запрос').toBeOK()
const sedo_addressee_list_response_1Json = await sedo_addressee_list_response_1.json()

const sedo_employee_query_response_2 = await request.post('https://192.168.42.201/sedo/employee/query', {
data: {
filter: {
filterIds: [
],
...
await expect(sedo_employee_query_response_2, 'Успешный запрос').toBeOK()
const sedo_employee_query_response_2Json = await sedo_employee_query_response_2.json()

const sedo_orgstructure_organizations_response_1 = await request.post('https://192.168.42.201/sedo/orgstructure/organizations', {
data: {
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_orgstructure_organizations_response_1, 'Успешный запрос').toBeOK()
const sedo_orgstructure_organizations_response_1Json = await sedo_orgstructure_organizations_response_1.json()

const sedo_orgstructure_branches_response_1 = await request.post('https://192.168.42.201/sedo/orgstructure/branches', {
data: {
id: sedo_employee_bylogin_response_1Json.organization[0].r_object_id,
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_orgstructure_branches_response_1, 'Успешный запрос').toBeOK()
const sedo_orgstructure_branches_response_1Json = await sedo_orgstructure_branches_response_1.json()

const sedo_orgstructure_departments_response_1 = await request.post('https://192.168.42.201/sedo/orgstructure/departments', {
data: {
branchIds: [
sedo_employee_bylogin_response_1Json.organization[0].branches[0].r_object_id
],
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_orgstructure_departments_response_1, 'Успешный запрос').toBeOK()
const sedo_orgstructure_departments_response_1Json = await sedo_orgstructure_departments_response_1.json()

const sedo_pref_create_or_update_response_1 = await request.post('https://192.168.42.201/sedo/pref/create_or_update', {
data: {
...
await expect(sedo_pref_create_or_update_response_1, 'Успешный запрос').toBeOK()
const sedo_employee_query_response_3 = await request.post('https://192.168.42.201/sedo/employee/query', {
data: {
filter: {
organizationId: sedo_employee_bylogin_response_1Json.organization[0].r_object_id,
branchId: sedo_employee_bylogin_response_1Json.organization[0].branches[0].r_object_id,
filterIds: [
],
docId: sedo_document_create_response_1Json.id,
restrictDocumentParticipants: false,
...
await expect(sedo_employee_query_response_3, 'Успешный запрос').toBeOK()
const sedo_employee_query_response_3Json = await sedo_employee_query_response_3.json()

const sedo_addressee_00000002001e4ax0_create_response_1 = await request.post('https://192.168.42.201/sedo/addressee/00000002001e4ax0/create', {
data: {
employeeIds: [
sedo_task_list_response_1Json.content[20].appointedExecutors[2].emplId
],
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_addressee_00000002001e4ax0_create_response_1, 'Успешный запрос').toBeOK()
const sedo_addressee_00000002001e4ax0_create_response_1Json = await sedo_addressee_00000002001e4ax0_create_response_1.json()

const sedo_addressee_list_response_2 = await request.post('https://192.168.42.201/sedo/addressee/list', {
data: {
documentId: sedo_document_create_response_1Json.id,
documentType: 'ddt_outcoming_type_doc',
agentsSort: {
...
await expect(sedo_addressee_list_response_2, 'Успешный запрос').toBeOK()
const sedo_addressee_list_response_2Json = await sedo_addressee_list_response_2.json()

const sedo_document_get_response_3 = await request.post('https://192.168.42.201/sedo/document/get', {
data: {
id: sedo_document_create_response_1Json.id,
type: 'ddt_outcoming_type_doc',
classificationId: sedo_favorite_list_response_1Json[2].id,
...
await expect(sedo_document_get_response_3, 'Успешный запрос').toBeOK()
const sedo_document_get_response_3Json = await sedo_document_get_response_3.json()

const sedo_document_get_audit_response_3 = await request.post('https://192.168.42.201/sedo/document/get/audit', {
data: {
id: sedo_document_create_response_1Json.id,
type: 'ddt_outcoming_type_doc',
classificationId: sedo_favorite_list_response_1Json[2].id,
...
await expect(sedo_document_get_audit_response_3, 'Успешный запрос').toBeOK()
const sedo_doc_settings_get_response_4 = await request.post('https://192.168.42.201/sedo/doc_settings/get', {
data: {
dsidDocument: sedo_document_create_response_1Json.id,
documentType: 'ddt_outcoming_type_doc',
token: ts_simple_login_response_1Json.token
...
await expect(sedo_doc_settings_get_response_4, 'Успешный запрос').toBeOK()
const sedo_doc_settings_get_response_4Json = await sedo_doc_settings_get_response_4.json()

const sedo_addressee_00000002001e4ax0_send_addressee_response_1 = await request.post('https://192.168.42.201/sedo/addressee/00000002001e4ax0/send_addressee', {
data: {
ids: [
sedo_addressee_00000002001e4ax0_create_response_1Json[0]
],
token: ts_simple_login_response_1Json.token
}
})
await expect(sedo_addressee_00000002001e4ax0_send_addressee_response_1, 'Успешный запрос').toBeOK()
const sedo_addressee_list_response_3 = await request.post('https://192.168.42.201/sedo/addressee/list', {
data: {
documentId: sedo_document_create_response_1Json.id,
documentType: 'ddt_outcoming_type_doc',
agentsSort: {
...
await expect(sedo_addressee_list_response_3, 'Успешный запрос').toBeOK()
const sedo_addressee_list_response_3Json = await sedo_addressee_list_response_3.json()

const sedo_content_edit_list_response_4 = await request.post('https://192.168.42.201/sedo/content/edit/list', {
data: {
ids: [
null,
],
...
await expect(sedo_content_edit_list_response_4, 'Успешный запрос').toBeOK()
const sedo_content_edit_list_response_4Json = await sedo_content_edit_list_response_4.json()
